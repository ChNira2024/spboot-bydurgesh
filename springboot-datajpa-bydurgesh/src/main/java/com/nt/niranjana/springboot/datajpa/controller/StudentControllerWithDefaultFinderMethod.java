...
import com.nt.niranjana.springboot.datajpa.exception.DataNotFoundException;
...
public class StudentControllerWithDefaultFinderMethod
{
	...
	{
		logger.info("StudentControllerWithDefaultFinderMethod: This is fetchAllStudentsDetails method{}");
		...
		logger.info("StudentControllerWithDefaultFinderMethod:fetchAllStudentsDetails from Databse"+fetchedAllStudentsData.toString());
	...
	public ResponseEntity<Students> updateStudentsDetails(@RequestBody Students student ,@PathVariable("id") int id)
	{
		...
		if(id == 0 || student.getSno()==null)
		{
			throw new DataNotFoundException("StudentData and ID must not be zero or null !!");
		}
		try
		{
